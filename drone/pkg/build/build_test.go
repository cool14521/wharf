...
func TestSetup(t *testing.T) {
	...
	b := Builder{}
	b.Repo = &repo.Repo{}
	b.Repo.Path = "git://github.com/dockercn/docker-bucket/drone.git"
...
func TestWriteBuildScript(t *testing.T) {
	...
	b.Repo = &repo.Repo{
		Path:   "git://github.com/dockercn/docker-bucket/drone.git",
		Branch: "master",
		Commit: "e7e046b35",
		PR:     "123",
		Dir:    "/var/cache/drone/github.com/dockercn/docker-bucket/drone"}
	...
	f.WriteEnv("DRONE_BUILD_DIR", "/var/cache/drone/github.com/dockercn/docker-bucket/drone")
	...
	f.WriteCmd("git clone --depth=0 --recursive --branch=master git://github.com/dockercn/docker-bucket/drone.git /var/cache/drone/github.com/dockercn/docker-bucket/drone")
