...
func (this *ImageAPIController) GetImageJSON() {
	...
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthGetImageJSON)
...
func (this *ImageAPIController) PutImageJSON() {
	...
	//	beego.Error("Session Access:::", this.GetSession("access").(string))
	//	beego.Error("Ctx.Session Access:::", this.Ctx.Input.Session("access").(string))
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthPutImageJSON)
...
func (this *ImageAPIController) PutImageLayer() {
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthPutImageLayer)
...
func (this *ImageAPIController) PutChecksum() {
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthPutChecksum)
...
func (this *ImageAPIController) GetImageAncestry() {
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthGetImageAncestry)
...
func (this *ImageAPIController) GetImageLayer() {
	...
	isAuth, errCode, errInfo := models.DoAuth(this.Ctx, models.AuthGetImageLayer)
	...
	image := new(models.Image)
	layerfile, err := image.GetPath(imageId, sign, true, true)
	if err != nil {
